    ...
    <div className="">
        ...
        <div className="flex flex-col items-center justify-center mt-20 lg:mt-2">
            ...
            <div className="text-center text-black text-[0.625rem] lg:text-sm m-4">
                <p className="font-bold">Transaksi pembayaran kelas premium berhasil!</p>
            ...
            <button 
                className="w-40 h-8 lg:w-72 lg:h-8 bg-white text-[#489CFF] font-bold text-[0.625rem] lg:text-sm rounded-2xl p-1 px-4">
                Kembali ke Beranda
            </button>
